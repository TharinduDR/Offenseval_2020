...
from algo.neural_nets.models.cnn.args.english_args import SPLIT_RATIO, BATCH_SIZE, \
...
from algo.neural_nets.models.cnn.args.english_args import SUBMISSION_FOLDER, TEST_FILE, SUBMISSION_FILE, \
    RESULT_FILE
from algo.neural_nets.models.cnn.common.model import CNN
from project_config import SEED, VECTOR_CACHE, ENGLISH_DATA_PATH, ENGLISH_TEST_PATH
