...
from algo.neural_nets.common.preprocessing.turkish_preprocessing import pipeline
...
from algo.neural_nets.models.cnn.args.turkish_args import SUBMISSION_FOLDER, TEST_FILE, SUBMISSION_FILE, \
    RESULT_FILE
from algo.neural_nets.models.cnn.args.turkish_args import SPLIT_RATIO, TURKISH_EMBEDDING_PATH, BATCH_SIZE, \
    MODEL_PATH, TEMP_DIRECTORY, TRAIN_FILE, DEV_FILE, N_FOLD, LEARNING_RATE, REDUCE_LEARNING_RATE_THRESHOLD, \
    REDUCE_LEARNING_RATE_FACTOR, FIXED_LENGTH, N_EPOCHS, MODEL_NAME, GRADUALLY_UNFREEZE, FREEZE_FOR, DEV_RESULT_FILE
from algo.neural_nets.models.cnn.common.model import CNN
from project_config import SEED, TURKISH_DATA_PATH, VECTOR_CACHE, TURKISH_TEST_PATH
...
for i in range(N_FOLD):
    ...
    logging.info(f'Number of test examples: {len(dev_data)}')
