...
from algo.neural_nets.models.cnn.args.danish_args import SUBMISSION_FOLDER, DEV_FILE, TEST_FILE, SUBMISSION_FILE, \
    RESULT_FILE
...
from project_config import SEED, DANISH_DATA_PATH, VECTOR_CACHE, DANISH_TEST_PATH
